    ...
    <main className="min-h-screen bg-[#F8F6F2] text-[#080808]">
      ...
      <section className="lg:ml-64">
        ...
        <div className="px-5 py-7 sm:px-8 lg:px-10">
          {/* WELCOME BANNER */}
          <section className="relative overflow-hidden rounded-3xl border border-[#A06E31]/30 bg-linear-to-r from-[#D5C1A9] to-[#C9B195] p-6 sm:p-8 lg:p-10">
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="mt-4 max-w-xl text-sm leading-6 text-black/65 sm:text-base">
                Keep track of your orders, customers, products and cash on
                delivery sales from one simple dashboard.
              </p>

              <Link
                href="/admin/orders"
                className="mt-6 inline-flex rounded-full bg-[#1D1612] px-6 py-3 text-sm font-medium text-white shadow-xs transition-all duration-300 hover:-translate-y-1 hover:bg-[#A06E31]"
              >
                View Orders
              </Link>
            </div>
            ...
            {stats.map((stat) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[#D5C1A9]/50 bg-[#FAF7F2] text-[#A06E31] transition-transform duration-300 group-hover:scale-110">
                    {stat.icon}
                  </div>
                </div>
              </div>
          ...
          <section className="mt-7 grid grid-cols-1 gap-6 xl:grid-cols-[1.7fr_1fr]">
            ...
            <div className="rounded-2xl border border-[#D5C1A9]/60 bg-white p-6 shadow-xs">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#A06E31]">
                    Performance
                  </p>
                ...
                {salesData.map((item) => (
                  ...
                  >
                    <div className="relative flex w-full flex-1 items-end">
                      ...
                      <span className="absolute -top-7 left-1/2 hidden -translate-x-1/2 whitespace-nowrap rounded-md bg-[#1D1612] px-2 py-1 text-[10px] text-white shadow-xs group-hover:block">
                        {item.value}k
                      </span>
                    </div>
          ...
          {/* RECENT ORDERS */}
          <section className="mt-7 overflow-hidden rounded-2xl border border-[#D5C1A9]/60 bg-white shadow-xs">
              ...
              <table className="w-full min-w-[700px]">
                <thead>
                  <tr className="border-b border-black/5 text-left text-xs uppercase tracking-wider text-black/40">
                    ...
                    <th className="px-6 py-4 font-medium">Amount (COD)</th>
                ...
                <tbody>
                  {recentOrders.map((order) => (
                    <tr
                      key={order.id}
                      className="border-b border-black/5 transition-colors last:border-0 hover:bg-[#F8F6F2]"
                    >
              ...
              {recentOrders.map((order) => (
                ...
                >
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <p className="text-xs text-black/45">{order.product}</p>
          ...
          <section className="mt-7 grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-8 w-8 items-center justify-center rounded-full border border-black/5 bg-[#F8F6F2]">
                  <StarIcon />
                </div>
              </div>

              <div className="mt-6 flex items-center gap-4 rounded-2xl border border-black/5 bg-[#F8F6F2] p-4">
